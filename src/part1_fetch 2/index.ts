 ...
 *
 * Chain: Worker → mail.mobicycle.productions (tunnel) → localhost:4000 (backend) → 127.0.0.1:1143 (bridge)
 *
 * checkTunnel()  — can we reach mail.mobicycle.productions?
...
/**
 * Check hop 1: tunnel (mail.mobicycle.productions)
 */
