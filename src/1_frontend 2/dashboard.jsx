      ...
      <Panel title="Accounts" subtitle="ProtonMail accounts connected via Bridge">
        <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "8px" }}>
          {["rose@mobicycle.ee", "rose@mobicycle.productions", "rose@mobicycle.consulting", "rose@mobicycle.us", "rose@mobicycle.eu"].map((email) => (
            <div key={email} style={{ padding: "10px", background: "#0d0e14", borderRadius: "6px", border: "1px solid #1e1f2a", fontSize: "12px", color: email === "rose@mobicycle.productions" ? "#7cb5ec" : "#555", fontWeight: email === "rose@mobicycle.productions" ? 600 : 400 }}>
              {email}
              {email === "rose@mobicycle.productions" && <span style={{ marginLeft: "6px", fontSize: "10px", color: "#52c41a" }}>ACTIVE</span>}
            </div>
          ))}
        </div>
      </Panel>
    ...
    <div style={{ minHeight: "100vh", background: "#090a10", color: "#d0d0d5", fontFamily: "'SF Pro Text', -apple-system, 'Segoe UI', Roboto, sans-serif" }}>
      <div style={{ background: "#0d0e14", borderBottom: "1px solid #1e1f2a", padding: "14px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          ...
          <div>
            <h1 style={{ margin: 0, fontSize: "18px", fontWeight: 700, color: "#e8e8ed", letterSpacing: "-0.01em" }}>MobiCycle Productions · Email Workflow</h1>
            <p style={{ margin: 0, fontSize: "11px", color: "#555" }}>rose@mobicycle.productions · ProtonMail Bridge → Worker → KV · 3 CRON jobs</p>
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
